...
VALUES ('OFFICE', 'Zastavskaya, 22, SPB, RU', 59.888679, 30.327674);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('OFFICE', 'nab. Chyornoy rechki, 41, SPB, RU', 59.985629, 30.307862);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('OFFICE', 'Pevcheskiy, 12, SPB, RU', 59.960085, 30.324927);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('HOME', 'Koroleva, 34k1, SPB, RU', 60.014477, 30.259579);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('HOME', 'Petergofskoe av, 45', 59.849097, 30.152099);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('HOME', 'Kommunarov, 114, SPB, RU', 59.78433, 30.147422);
INSERT INTO address (type, address, latitude, longitude)
VALUES ('HOME', 'Voronezhskaya, 5, SPB, RU', 59.918165, 30.348719);
...
VALUES (
  ...
  (SELECT id FROM address WHERE address = 'Zastavskaya, 22, SPB, RU'),
  (SELECT id FROM address WHERE address = 'Koroleva, 34k1, SPB, RU'),
...
VALUES (
  ...
  (SELECT id FROM address WHERE address = 'Zastavskaya, 22, SPB, RU'),
  (SELECT id FROM address WHERE address = 'Kommunarov, 114, SPB, RU'),
...
VALUES (
  ...
  (SELECT id FROM address WHERE address = 'Zastavskaya, 22, SPB, RU'),
  (SELECT id FROM address WHERE address = 'Voronezhskaya, 5, SPB, RU'),
